...
# NOTE: This is duplicated from the official jinja repository.  Not ideal, but
# there's no way to import it because the `docs/` directory is not a part of the
# jinja python module
# The duplication here is preferable to duplicating all of the docstrings for 
# filters/globals/etc
